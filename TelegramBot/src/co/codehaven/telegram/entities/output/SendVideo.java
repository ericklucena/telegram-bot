...
public class SendVideo implements ITelegramApiMethod{
	
	private static final String PATH = "sendVideo";
	...
	public SendVideo(String chat_id, String document) {
		super();
		this.chat_id = chat_id;
		this.video = document;
	}

	public SendVideo(String chat_id, String video, Integer duration, String caption, Integer replyToMessageId,
	...
	public JSONObject toJson() {
		...
		json.put(VIDEO_FIELD, this.video);
